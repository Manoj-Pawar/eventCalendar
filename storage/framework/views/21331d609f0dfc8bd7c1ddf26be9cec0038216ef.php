     ...
     <div calss="row">
         ...
         <div calss="col-md-8 col-md-offset-2">
              <div calss="panel panel-default">
                  ...
                  <h1> Task : Add Data </h1>
        <form method="POST" action="<?php echo e(route('addevent.store')); ?>"  enctype="multipart/form-data">
...
</html><?php /**PATH E:\Laravel Projects\Event_Calendar\resources\views/addevent.blade.php ENDPATH**/ ?>